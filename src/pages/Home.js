...
const Home = () => {
    ...
    const getData = async () => {
        try {
            const response = await fetch(`https://us-central1-back-e8f9a.cloudfunctions.net/api/todos/todo@gmail.com`)
        ...
        <>
            ...
            <div className='home-con'>
                <div className='header-home'>
                    ...
                    {!authToken ? <NavLink className={'Nav-link'} to={'/todo'}>SignUp</NavLink> : <NavLink className={'Nav-link'} to={'/todo'}>Todo</NavLink>}
                </div>
                <div className='hero-home'>
                    <div className='content-home'>
                        <h1>Why OGTodo ?</h1>
                        <p>Do you often feel overwhelmed by the
                            number of tasks you have to do? Do you struggle to keep
                            track of your progress and deadlines? Do you wish you had
                            a simple and effective way to organize your life?</p>
                        <p>then you need OGTodo, the ultimate app for managing your
                            personal and professional projects. OGTodo is a smart and
                            intuitive app that lets you create, edit, and complete tasks
                ...
                <div className='hero2'>
                    <h3>OGTodo is more than just an app. It's a lifestyle.
                        ...
                        It's a tool to help you become more productive, organized, and happy. </h3>
                    <h3>And you can download OGTodo today and discover the difference it can make in your life.
                        OGTodo: the app that does it all.</h3>
                    {!authToken ? <NavLink className={'Nav-link'} to={'/todo'}>SignUp</NavLink> : <NavLink className={'Nav-link'} to={'/todo'}>Todo</NavLink>}
                </div>
            </div>
            <M />
