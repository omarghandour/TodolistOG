...
console.log('ddd');
self.addEventListener("activate" , async(e)=>{
const subscription = await self.registeration.subscrip({
  userVisibleOnly: true,
  applicationServerKey: urlBase64ToUint8Array("BEgXekP9y_rA2BpELdPtfd2HDFvfhDb3L5b21K6kpKIBmcAot3O4N0TbIj39Z0MPcYm7Ye9jaAjH7xO2VybWedU")
