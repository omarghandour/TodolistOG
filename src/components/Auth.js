...
const Auth = () => {
    ...
    const handleSubmit = async (e, endpoint) => {
        ...
        const response = await fetch(`https://us-central1-back-e8f9a.cloudfunctions.net/api/${endpoint}`, {
            method: 'POST',
        ...
        <div className='con-auth'>
            ...
            <div className='auth-container'>
                <div className='auth-container-box'>
                    ...
                    <p style={{ padding: "15px" }}>By registering, You agree to the
                        Terms, Conditions and Policies of OGTodo & Privacy Policy</p>
                </div>
            </div>
        </div>
    )
